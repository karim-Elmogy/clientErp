...
type AccessoiesDashboardProps_TP = {
    title: string
    image: string
    icon: any
...
const AccessoriesDashboard = ({title, image, icon, textBondNumber, bondNumber, viewHandler, addHandler } : AccessoiesDashboardProps_TP) => {
